...
import { AGENT_COMMENTS_BY_ID } from '../utils/constants/routes';
...
const AgentComments = () => {
    ...
    const { isError, data, error, fetchNextPage, hasNextPage, isFetching } = useFetchInfinite("allagentreviews", AGENT_COMMENTS_BY_ID, null, null , agent_id);
    ...
    return (
        <SafeAreaView style={[generalStyles.ScreenContainer]}>
            ...
            <TouchableOpacity
                activeOpacity={1}
                style={styles.fab} onPress={() => navigation.navigate("AddAgentReview", { agent_id })}>
